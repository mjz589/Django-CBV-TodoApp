...
class TestTaskApi():
    ...
    def test_get_task_create_response_201_status(self, api_client, common_user):
    ...
    def test_get_task_put_response_200_status(self, api_client, common_user, create_task):
    ...
    def test_get_task_patch_response_200_status(self, api_client, common_user, create_task):
    ...
    def test_get_task_delete_response_204_status(self, api_client, common_user, create_task):
